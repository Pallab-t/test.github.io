...
// Returns the private 'fos_http_cache.command.invalidate_path' shared service.
...
$this->privates['fos_http_cache.command.invalidate_path'] = $instance = new \FOS\HttpCacheBundle\Command\InvalidatePathCommand(($this->services['fos_http_cache.cache_manager'] ?? $this->getFosHttpCache_CacheManagerService()));
