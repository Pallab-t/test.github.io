...
return $this->services['security.password_encoder'] = new \Symfony\Component\Security\Core\Encoder\UserPasswordEncoder(($this->services['security.encoder_factory'] ?? $this->load('getSecurity_EncoderFactoryService.php')));
