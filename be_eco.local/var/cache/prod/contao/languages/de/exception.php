...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'Die Skriptausführung wurde gestoppt, weil irgendetwas nicht korrekt funktioniert. Die eigentliche Fehlermeldung wird aus Sicherheitsgründen hinter dieser Meldung verborgen und findet sich in der aktuellen Log-Datei (siehe oben). Wenn Sie die Fehlermeldung nicht verstehen oder nicht wissen, wie das Problem zu beheben ist, durchsuchen Sie die <a href="https://contao.org/de/faq.html" target="_blank" rel="noreferrer noopener">Contao-FAQs</a> oder besuchen Sie die <a href="https://contao.org/de/support.html" target="_blank" rel="noreferrer noopener">Contao-Supportseite</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'Durchsuchen Sie die <a href="https://contao.org/de/faq.html" target="_blank" rel="noreferrer noopener">Contao-FAQs</a> oder besuchen Sie die <a href="https://contao.org/de/support.html" target="_blank" rel="noreferrer noopener">Contao-Supportseite</a> für weitere Informationen.';
