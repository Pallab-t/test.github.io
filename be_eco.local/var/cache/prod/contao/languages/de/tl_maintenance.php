...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['images'][1] = 'Löscht die automatisch erstellten Bilder und leert anschließend den Shared-Cache, damit keine ungültigen Links zurück bleiben.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][0] = 'Den Suchergebnis-Cache leeren';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Schreibt die XML-Dateien (Sitemaps/Feeds) neu und leert anschließend den Shared-Cache, damit keine ungültigen Links zurück bleiben.';
...
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadDebugLog'] = 'Debug-Log herunterladen';
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadSubscriberLog'] = 'Log herunterladen';
