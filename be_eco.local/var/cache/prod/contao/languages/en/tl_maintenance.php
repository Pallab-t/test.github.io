...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][0] = 'Purge the search results cache';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Recreates the XML files (sitemaps and feeds) and then purges the shared cache, so there are no links to deleted resources.';
...
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadDebugLog'] = 'Download the debug log';
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadSubscriberLog'] = 'Download the log';
