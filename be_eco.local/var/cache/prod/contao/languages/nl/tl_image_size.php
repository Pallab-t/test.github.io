...
$GLOBALS['TL_LANG']['tl_image_size']['sizes'][1] = 'Hier kunt de weer te geven beeldbreedte(s) bepalen, b.v. <em>(max-width: 600px) 100vw, 50vw</em>.';
...
$GLOBALS['TL_LANG']['tl_image_size']['formatsWebpNotSupported'] = 'WEBP wordt niet ondersteund door uw server.';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][0] = 'Gebruik de originele afbeelding als de afmetingen overeenkomen';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][1] = 'Bedenk dat in dit geval geen optimalisaties zoals het strippen van metagegevens of jpeg-compressie worden toegepast.';
...
$GLOBALS['TL_LANG']['tl_image_size']['png:webp,png'] = 'PNG naar WEBP';
$GLOBALS['TL_LANG']['tl_image_size']['jpg:webp,jpg;jpeg:webp,jpeg'] = 'JPEG naar WEBP';
$GLOBALS['TL_LANG']['tl_image_size']['gif:webp,gif'] = 'GIF naar WEBP';
