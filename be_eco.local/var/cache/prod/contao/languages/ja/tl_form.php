...
// vendor/contao/core-bundle/src/Resources/contao/languages/ja/tl_form.xlf
...
$GLOBALS['TL_LANG']['tl_form']['customTpl'][1] = 'フォームのテンプレートを選択できます。';
...
$GLOBALS['TL_LANG']['tl_form']['editheader'] = 'ID %sのフォームの設定を変更';
