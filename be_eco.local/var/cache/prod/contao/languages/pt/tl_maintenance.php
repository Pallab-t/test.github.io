...
$GLOBALS['TL_LANG']['tl_maintenance']['maintenanceMode'] = 'Modo de Manutenção';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['index'][1] = 'Trunca as tabelas <code>tl_search</code> and <code>tl_search_index</code>. Posteriormente, terá que reconstruir o index de pesquisa (ver acima).';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][0] = 'Limpa a cache de resultados de pesquisa';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][1] = 'Limpa resultados de pesquisa em cache.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Recria ficheiros XML (sitemaps e feeds) e em seguida remove a cache partilhada, para que não existam links para recursos removidos.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][0] = 'Recriar symlinks';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][1] = 'Recria symlinks na pasta <code>web/</code> (root de documentos).';
...
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadDebugLog'] = 'Debug log em download';
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadSubscriberLog'] = 'Download do log';
