...
class __TwigTemplate_fb8c60f5dc4d090504f37557e82e1e10cdbc6ba7e25504453a55112991bf030b extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
        ...
        if (($context["authenticationError"] ?? null)) {
            // line 8
            echo "<p>";
            echo twig_escape_filter($this->env, $this->extensions['Symfony\Bridge\Twig\Extension\TranslationExtension']->trans(($context["authenticationError"] ?? null), ($context["authenticationErrorData"] ?? null), "SchebTwoFactorBundle"), "html", null, true);
            echo "</p>
";
        }
        // line 10
...
<form class=\"form\" action=\"";
        // line 21
        ((($context["checkPathUrl"] ?? null)) ? (print (twig_escape_filter($this->env, ($context["checkPathUrl"] ?? null), "html", null, true))) : (print ($this->extensions['Symfony\Bridge\Twig\Extension\RoutingExtension']->getPath(($context["checkPathRoute"] ?? null)))));
        echo "\" method=\"post\">
    <p class=\"widget\">
        <input
            id=\"_auth_code\"
...
";
        ...
        echo twig_escape_filter($this->env, ($context["logoutPath"] ?? null), "html", null, true);
        echo "\">";
...
";
    ...
    {
        return new Source("", "@SchebTwoFactor/Authentication/form.html.twig", "C:\\xampp\\htdocs\\be_eco.local\\vendor\\scheb\\two-factor-bundle\\Resources\\views\\Authentication\\form.html.twig");
    }
}
