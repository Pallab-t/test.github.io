...
$a->addLoader(new \Contao\CoreBundle\Routing\ImagesLoader(\dirname(__DIR__, 4), (\dirname(__DIR__, 4).'/assets/images'), ($this->services['filesystem'] ?? ($this->services['filesystem'] = new \Symfony\Component\Filesystem\Filesystem()))));
$a->addLoader($c);
