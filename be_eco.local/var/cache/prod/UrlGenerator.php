...
return [
    ...
    'contao_backend_preview' => [[], ['_scope' => 'backend', '_controller' => 'Contao\\CoreBundle\\Controller\\BackendPreviewController'], [], [['text', '/contao/preview']], [], []],
    'contao_backend_switch' => [[], ['_scope' => 'backend', '_controller' => 'Contao\\CoreBundle\\Controller\\BackendPreviewSwitchController'], [], [['text', '/contao/preview_switch']], [], []],
    ...
    'contao_frontend_check_cookies' => [[], ['_scope' => 'frontend', '_token_check' => true, '_controller' => 'Contao\\CoreBundle\\Controller\\FrontendController::checkCookiesAction'], [], [['text', '/_contao/check_cookies']], [], []],
    ...
    'contao_images' => [['path'], ['_controller' => 'Contao\\CoreBundle\\Controller\\ImagesController', '_bypass_maintenance' => true], ['path' => '.+'], [['variable', '/', '.+', 'path'], ['text', '/assets/images']], [], []],
