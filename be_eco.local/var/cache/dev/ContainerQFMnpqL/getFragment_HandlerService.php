...
return $this->services['fragment.handler'] = new \Contao\CoreBundle\Fragment\FragmentHandler($a, new \Symfony\Component\HttpKernel\DependencyInjection\LazyLoadingFragmentHandler($a, $b, true), $b, ($this->privates['contao.fragment.registry'] ?? $this->getContao_Fragment_RegistryService()), new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [], []), true);
