...
return $this->services['cache_warmer'] = new \Symfony\Component\HttpKernel\CacheWarmer\CacheWarmerAggregate(new RewindableGenerator(function () {
    ...
    yield 5 => ($this->privates['contao.cache.warm_internal'] ?? $this->load('getContao_Cache_WarmInternalService.php'));
}, 6), true, ($this->targetDir.''.'/appContao_ManagerBundle_HttpKernel_ContaoKernelDevDebugContainerDeprecations.log'));
