...
$this->privates['console.command.translation_update'] = $instance = new \Symfony\Bundle\FrameworkBundle\Command\TranslationUpdateCommand($a, ($this->privates['translation.reader'] ?? $this->load('getTranslation_ReaderService.php')), ($this->privates['translation.extractor'] ?? $this->load('getTranslation_ExtractorService.php')), 'en', (\dirname(__DIR__, 4).'/translations'), (\dirname(__DIR__, 4).'/templates'), [0 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\security-core/Resources/translations')], [0 => (\dirname(__DIR__, 4).'\\vendor\\knplabs\\knp-menu\\src\\Knp\\Menu/Resources/views'), 1 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\twig-bridge/Resources/views/Email'), 2 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\http-kernel\\DependencyInjection\\ServicesResetter.php'), 3 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\Command\\TranslationDebugCommand.php'), 4 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\framework-bundle\\CacheWarmer\\TranslationsCacheWarmer.php'), 5 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\translation\\DataCollector\\TranslationDataCollector.php'), 6 => (\dirname(__DIR__, 4).'\\vendor\\symfony\\twig-bridge\\Extension\\TranslationExtension.php'), 7 => (\dirname(__DIR__, 4).'\\vendor\\knplabs\\knp-time-bundle\\Knp\\Bundle\\TimeBundle\\DateTimeFormatter.php'), 8 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\BackendLocaleListener.php'), 9 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\Menu\\BackendMenuListener.php'), 10 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\Menu\\BackendLogoutListener.php'), 11 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\Menu\\BackendPreviewListener.php'), 12 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\InsertTags\\TranslationListener.php'), 13 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\EventListener\\LocaleSubscriber.php'), 14 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Controller\\BackendCsvImportController.php'), 15 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Controller\\FrontendModule\\TwoFactorController.php'), 16 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Crawl\\Escargot\\Subscriber\\BrokenLinkCheckerSubscriber.php'), 17 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Crawl\\Escargot\\Subscriber\\SearchIndexSubscriber.php'), 18 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Picker\\PagePickerProvider.php'), 19 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Picker\\FilePickerProvider.php'), 20 => (\dirname(__DIR__, 4).'\\vendor\\contao\\news-bundle\\src\\Picker\\NewsPickerProvider.php'), 21 => (\dirname(__DIR__, 4).'\\vendor\\contao\\calendar-bundle\\src\\Picker\\EventPickerProvider.php'), 22 => (\dirname(__DIR__, 4).'\\vendor\\contao\\faq-bundle\\src\\Picker\\FaqPickerProvider.php'), 23 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Picker\\ArticlePickerProvider.php'), 24 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Picker\\TablePickerProvider.php'), 25 => (\dirname(__DIR__, 4).'\\vendor\\contao\\core-bundle\\src\\Slug\\ValidCharacters.php'), 26 => (\dirname(__DIR__, 4).'\\vendor\\contao\\installation-bundle\\src\\Database\\Version447Update.php'), 27 => (\dirname(__DIR__, 4).'\\vendor\\contao\\manager-bundle\\src\\EventListener\\BackendMenuListener.php')]);
