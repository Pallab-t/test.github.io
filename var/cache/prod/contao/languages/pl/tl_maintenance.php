...
$GLOBALS['TL_LANG']['tl_maintenance']['maintenanceMode'] = 'Tryb konserwacji';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['index'][1] = 'Czyści tabele <code>tl_search</code> i <code>tl_search_index</code>. Po wszystkim powinieneś przebudować indeks wyszukiwarki (patrz wyżej).';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][0] = 'Wyczyść pamięć podręczną wyników wyszukiwania';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][1] = 'Usuwa cacheowane wersje wyników wyszukiwania.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Odtwarza pliki XML (mapy stron i kanały), a następnie usuwa udostępnioną pamięć podręczną, więc nie ma żadnych łączy do usuniętych zasobów.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][0] = 'Odtwórz linki symboliczne (symlinks)';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][1] = 'Odtwarza linki symboliczne (symlinks) w folderze <code>web/</code>.';
...
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadDebugLog'] = 'Pobierz dziennik debugowania';
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadSubscriberLog'] = 'Pobierz dziennik';
