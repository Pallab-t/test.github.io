...
$GLOBALS['TL_LANG']['XPT']['errorExplain'] = 'The script execution stopped, because something does not work properly. The actual error message is hidden by this notice for security reasons and can be found in the current log file (see above). If you do not understand the error message or do not know how to fix the problem, search the <a href="https://contao.org/en/frequently-asked.html" target="_blank" rel="noreferrer noopener">Contao FAQs</a> or visit the <a href="https://contao.org/en/support.html" target="_blank" rel="noreferrer noopener">Contao support page</a>.';
...
$GLOBALS['TL_LANG']['XPT']['tokenExplainTwo'] = 'For more information, search the <a href="https://contao.org/en/frequently-asked.html" target="_blank" rel="noreferrer noopener">Contao FAQs</a> or visit the <a href="https://contao.org/en/support.html" target="_blank" rel="noreferrer noopener">Contao support page</a>.';
