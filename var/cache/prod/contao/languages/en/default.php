...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Learn more about speeding up your workflow by using <a href="https://docs.contao.org/manual/en/administration-area/back-end-keyboard-shortcuts/" title="Keyboard shortcuts overview" target="_blank" rel="noreferrer noopener">keyboard shortcuts</a>.';
...
$GLOBALS['TL_LANG']['MSC']['twoFactorBackupCodesShow'] = 'Show backup codes';
...
$GLOBALS['TL_LANG']['MSC']['twoFactorBackupCodesInfo'] = 'Put the codes in a safe spot. If you lose your authentication device and do not have backup codes, you cannot access your account anymore!';
...
$GLOBALS['TL_LANG']['MSC']['internalCssEditor'] = 'The internal CSS editor has been deprecated and will be removed in one of the next Contao versions! Please consider exporting your existing style sheets and re-adding them to the page layout as external style sheets.';
$GLOBALS['TL_LANG']['MSC']['serpPreview'][0] = 'Google search results preview';
$GLOBALS['TL_LANG']['MSC']['serpPreview'][1] = 'Here you can preview the meta data in the Google search results. Other search engines might show longer texts or crop at a different position.';
...
$GLOBALS['TL_LANG']['CRAWL']['searchIndex']['warning'] = '%d URI(s) were skipped (if you are missing one, checkout the debug log).';
...
$GLOBALS['TL_LANG']['MSC']['cal_repeat'] = 'This event is repeated %s%s. The next event will take place on <time datetime="%s" itemprop="startDate">%s</time>.';
