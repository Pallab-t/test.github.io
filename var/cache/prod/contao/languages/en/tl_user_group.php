...
$GLOBALS['TL_LANG']['tl_user_group']['stop'][1] = 'If you want to prevent the group from being active before a certain date/time, you can enter it here. Otherwise leave the field blank.';
...
$GLOBALS['TL_LANG']['tl_user_group']['toggle'] = 'Activate/deactivate user group ID %s';
