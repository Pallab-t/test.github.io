...
$GLOBALS['TL_LANG']['tl_image_size']['sizes'][1] = '表示する画像の(複数も可能な)幅を指定できます。例: <em>(max-width: 600px) 100vw, 50vw</em>';
...
$GLOBALS['TL_LANG']['tl_image_size']['formatsWebpNotSupported'] = 'サーバーがWEBPをサポートしていません。';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][0] = 'サイズが一致した場合は元の画像を使用';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][1] = 'この場合、メタデータの除去やJPEGの圧縮のような最適化は行わないことに注意してください。';
...
$GLOBALS['TL_LANG']['tl_image_size']['png:webp,png'] = 'PNGからWEBP';
$GLOBALS['TL_LANG']['tl_image_size']['jpg:webp,jpg;jpeg:webp,jpeg'] = 'JPEGからWEBP';
$GLOBALS['TL_LANG']['tl_image_size']['gif:webp,gif'] = 'GIFからWEBP';
