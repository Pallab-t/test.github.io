...
// vendor/contao/newsletter-bundle/src/Resources/contao/languages/ja/tl_newsletter.xlf
...
$GLOBALS['TL_LANG']['tl_newsletter']['text'][0] = 'テキストの内容';
...
$GLOBALS['TL_LANG']['tl_newsletter']['template'][1] = 'チャネルの電子メールのテンプレートを上書きできます。';
...
$GLOBALS['TL_LANG']['tl_newsletter']['sender'][0] = '独自の送信者の電子メールアドレス';
$GLOBALS['TL_LANG']['tl_newsletter']['sender'][1] = 'チャネルの送信者の送信者の電子メールアドレスの初期設定を上書きできます。';
$GLOBALS['TL_LANG']['tl_newsletter']['senderName'][0] = '独自の送信者の名前';
$GLOBALS['TL_LANG']['tl_newsletter']['senderName'][1] = 'チャネルの送信者の名前の初期設定を上書きできます。';
...
$GLOBALS['TL_LANG']['tl_newsletter']['start'][1] = '送信の処理が中断した場合に、特定の宛先から継続する補正値を入力できます。何通が送信されたかはシステムログの<code>NEWSLETTER</code>のカテゴリを選択すると確認できます。例えば、120通のメールが送信済みの場合は、121番目の宛先から送信を続けるために(0から数えた)120と入力します。';
...
$GLOBALS['TL_LANG']['tl_newsletter']['sender_legend'] = '送信者の設定';
...
$GLOBALS['TL_LANG']['tl_newsletter']['new'][0] = '新規作成';
$GLOBALS['TL_LANG']['tl_newsletter']['new'][1] = '新しいニュースレターを作成';
$GLOBALS['TL_LANG']['tl_newsletter']['show'] = 'ID %sのニュースレターの詳細を表示';
$GLOBALS['TL_LANG']['tl_newsletter']['edit'] = 'ID %sのニュースレターを編集';
$GLOBALS['TL_LANG']['tl_newsletter']['copy'] = 'ID %sのニュースレターを複製';
$GLOBALS['TL_LANG']['tl_newsletter']['cut'] = 'ID %sのニュースレターを移動';
$GLOBALS['TL_LANG']['tl_newsletter']['delete'] = 'ID %sのニュースレターを削除';
