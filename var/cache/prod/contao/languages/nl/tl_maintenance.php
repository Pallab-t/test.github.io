...
// vendor/contao/core-bundle/src/Resources/contao/languages/nl/tl_maintenance.xlf
...
$GLOBALS['TL_LANG']['tl_maintenance']['maintenanceMode'] = 'Onderhoud modus';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['index'][1] = 'Kort de tabellen <code>tl_search</ code> en <code>tl_search_index</ code> in. Hierna dient u de zoekindex weer opnieuw op te bouwen (zie hierboven) .';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['scripts'][1] = 'Verwijdert de automatisch gegenereerde <code>.css</code> en<code>.js</code>bestanden, maakt de interne style sheets aan en schoont de gedeelde cache op.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][0] = 'Verwijder de cache met zoekresultaten';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['search'][1] = 'Verwijdert de gecachte versies van de zoekresultaten.';
...
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['xml'][1] = 'Bouwt de XML-bestanden (sitemaps en feeds) en schoont de gedeelde pagina cache op, zodat er geen links naar verwijderde bronnen zijn.';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][0] = 'Symlinks opnieuw opbouwen';
$GLOBALS['TL_LANG']['tl_maintenance_jobs']['symlinks'][1] = 'Symlinks opnieuw opbouwen in de <code>web/</code> map (hoofdmap).';
...
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadDebugLog'] = 'Download het foutopsporingslogboek';
$GLOBALS['TL_LANG']['tl_maintenance']['crawlDownloadSubscriberLog'] = 'Download het logboek';
