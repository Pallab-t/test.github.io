...
// vendor/contao/core-bundle/src/Resources/contao/languages/nl/tl_settings.xlf
...
$GLOBALS['TL_LANG']['tl_settings']['disableCron'][1] = 'Schakel de periodieke commando scheduler uit en voer het <em>_contao/cron</em> script uit door een echte cron job (deze dient u handmatig in te stellen).';
...
$GLOBALS['TL_LANG']['tl_settings']['doNotRedirectEmpty'][1] = 'In geval van een lege URL toon de website in plaats van door te verwijzen naar de taal startpagina (niet aanbevolen).';
...
$GLOBALS['TL_LANG']['tl_settings']['disableRefererCheck'][1] = 'Request token niet controleren wanneer een formulier wordt ingediend (onveilig!)';
...
$GLOBALS['TL_LANG']['tl_settings']['cron_legend'] = 'Cronjob instellingen';
