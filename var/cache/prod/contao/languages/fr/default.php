...
// vendor/contao/core-bundle/src/Resources/contao/languages/fr/default.xlf
...
$GLOBALS['TL_LANG']['ERR']['minval'] = 'Le champ "%s" doit être au moins %d !';
$GLOBALS['TL_LANG']['ERR']['maxval'] = 'Le champ "%s" ne doit pas être supérieur à %d !';
...
$GLOBALS['TL_LANG']['ERR']['topLevelRegular'] = 'Il y a des pages de niveau supérieur dans la structure du site qui ne sont pas des pages racines du site.';
...
$GLOBALS['TL_LANG']['ERR']['invalidGoogleId'] = 'Veuillez saisir un ID numérique Google+ ou un nom personnalisé (vanity name).';
...
$GLOBALS['TL_LANG']['CTE']['accordion'] = 'Accordéon';
$GLOBALS['TL_LANG']['CTE']['accordionStart'][0] = 'Début de l\'enveloppe';
$GLOBALS['TL_LANG']['CTE']['accordionStart'][1] = 'Génère l\'ouverture du conteneur de l\'accordéon.';
$GLOBALS['TL_LANG']['CTE']['accordionStop'][0] = 'Fin de l\'enveloppe';
$GLOBALS['TL_LANG']['CTE']['accordionStop'][1] = 'Génère la fermeture du conteneur de l\'accordéon.';
$GLOBALS['TL_LANG']['CTE']['accordionSingle'][0] = 'Élément seul';
...
$GLOBALS['TL_LANG']['CTE']['markdown'][1] = 'Génère du code HTML à partir d\'un texte formaté  avec la syntaxe markdown.';
$GLOBALS['TL_LANG']['CTE']['slider'] = 'Galerie de contenu';
$GLOBALS['TL_LANG']['CTE']['sliderStart'][0] = 'Début de l\'enveloppe';
$GLOBALS['TL_LANG']['CTE']['sliderStart'][1] = 'Génère l\'ouverture du conteneur du slider.';
$GLOBALS['TL_LANG']['CTE']['sliderStop'][0] = 'Fin de l\'enveloppe';
...
$GLOBALS['TL_LANG']['PTY']['forward'][1] = 'Ce type de page réoriente automatiquement les visiteurs vers une autre page de la structure de site.';
...
$GLOBALS['TL_LANG']['MSC']['exact'][0] = 'Dimensions exactes';
$GLOBALS['TL_LANG']['MSC']['exact'][1] = 'L\'image sera redimensionnée aux dimensions données. Si nécessaire, elle sera recadrée.';
$GLOBALS['TL_LANG']['MSC']['crop'][0] = 'Partie importante';
$GLOBALS['TL_LANG']['MSC']['crop'][1] = 'Préserve la partie importante d\'une image comme spécifié dans l\'explorateur de fichiers.';
...
$GLOBALS['TL_LANG']['MSC']['loginAttempts'] = 'Tentatives de connexion';
$GLOBALS['TL_LANG']['MSC']['locked'] = 'Verrouillé';
...
$GLOBALS['TL_LANG']['MSC']['fileMeta'] = 'Meta-données';
...
$GLOBALS['TL_LANG']['MSC']['maintenanceEnabled'] = 'Le mode de maintenance est actuellement activé.';
...
$GLOBALS['TL_LANG']['MSC']['fileManager'] = 'Explorateur de fichiers';
$GLOBALS['TL_LANG']['MSC']['pageManager'] = 'Structure de site';
$GLOBALS['TL_LANG']['MSC']['filePickerHome'] = 'Revenir au sélecteur de fichiers';
$GLOBALS['TL_LANG']['MSC']['pagePickerHome'] = 'Revenir au sélecteur de pages';
...
$GLOBALS['TL_LANG']['MSC']['printAsPdf'] = 'Sauvegarder l\'article au format PDF';
...
$GLOBALS['TL_LANG']['MSC']['metaNoLanguages'] = 'Il vous faut ajouter une page racine dans la structure du site afin de stocker les méta-informations.';
...
// vendor/contao/calendar-bundle/src/Resources/contao/languages/fr/default.xlf
...
// vendor/contao/comments-bundle/src/Resources/contao/languages/fr/default.xlf
...
// vendor/contao/faq-bundle/src/Resources/contao/languages/fr/default.xlf
$GLOBALS['TL_LANG']['MSC']['faqCreatedBy'] = 'Dernière mise à jour le %s par %s.';
$GLOBALS['TL_LANG']['MSC']['faqPicker'] = 'FAQ';

// vendor/contao/news-bundle/src/Resources/contao/languages/fr/default.xlf
...
$GLOBALS['TL_LANG']['MSC']['newsPicker'] = 'Actualités';

// vendor/contao/newsletter-bundle/src/Resources/contao/languages/fr/default.xlf
...
$GLOBALS['TL_LANG']['ERR']['blacklisted'] = 'L\'adresse e-mail a été désabonnée de la liste de diffusion.';
