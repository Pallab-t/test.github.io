...
$GLOBALS['TL_LANG']['MSC']['shortcuts'][1] = 'Wie Sie Ihren Arbeitsablauf durch die Verwendung von <a href="https://docs.contao.org/books/manual/current/de/02-administrationsbereich/backend-tastaturkuerzel.html" title="Übersicht der Tastaturkürzel" target="_blank" rel="noreferrer noopener">Tastaturkürzeln</a> beschleunigen.';
...
$GLOBALS['TL_LANG']['MSC']['twoFactorBackupCodesShow'] = 'Backup-Codes anzeigen';
...
$GLOBALS['TL_LANG']['MSC']['twoFactorBackupCodesInfo'] = 'Bewahren Sie die Codes sicher auf! Wenn Sie Ihr Authentifizierungsgerät verlieren und keine Backup-Codes haben, können Sie nicht mehr auf Ihr Konto zugreifen!';
...
$GLOBALS['TL_LANG']['MSC']['internalCssEditor'] = 'Der interne CSS-Editor ist veraltet und wird in einer der nächsten Contao-Versionen entfernt! Bitte erwägen Sie, Ihre bestehenden Stylesheets zu exportieren und sie als externe Stylesheets im Seitenlayout einzubinden.';
...
$GLOBALS['TL_LANG']['CRAWL']['searchIndex']['warning'] = '%d URL(s) wurde(n) übersprungen (wenn Sie eine URL vermissen, prüfen Sie das Debug-Log).';
...
$GLOBALS['TL_LANG']['MSC']['cal_repeat'] = 'Dieser Termin wiederholt sich %s%s und findet das nächste Mal am <time datetime="%s" itemprop="startDate">%s</time> statt.';
