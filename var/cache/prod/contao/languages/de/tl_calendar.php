...
$GLOBALS['TL_LANG']['tl_calendar']['editmeta'] = 'Kalendereinstellungen bearbeiten';
$GLOBALS['TL_LANG']['tl_calendar']['editheader'] = 'Einstellungen des Kalenders ID %s bearbeiten';
