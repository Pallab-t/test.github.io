...
$GLOBALS['TL_LANG']['tl_user_group']['stop'][1] = 'Wenn Sie die Gruppe erst ab einem bestimmten Zeitpunkt aktivieren möchten, können Sie diesen hier eingeben. Andernfalls lassen Sie das Feld leer. ';
...
$GLOBALS['TL_LANG']['tl_user_group']['toggle'] = 'Benutzergruppe ID %s aktivieren/deaktivieren';
