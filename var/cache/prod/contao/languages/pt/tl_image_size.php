...
$GLOBALS['TL_LANG']['tl_image_size']['sizes'][1] = 'Aqui pode definir a largura da imagem mostrada, por ex.<em>(largura máxima: 600px) 100vw, 50vw</em>.';
...
$GLOBALS['TL_LANG']['tl_image_size']['formatsWebpNotSupported'] = 'WEBP não suportado no servidor.';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][0] = 'Usar imagem original se as dimensões coincidirem';
$GLOBALS['TL_LANG']['tl_image_size']['skipIfDimensionsMatch'][1] = 'Note que nenhuma optimização tal como meta data stripping ou compressão JPEG serão aplicadas neste caso.';
...
$GLOBALS['TL_LANG']['tl_image_size']['png:webp,png'] = 'PNG para WEBP';
$GLOBALS['TL_LANG']['tl_image_size']['jpg:webp,jpg;jpeg:webp,jpeg'] = 'JPEG para WEBP';
$GLOBALS['TL_LANG']['tl_image_size']['gif:webp,gif'] = 'GIF para WEBP';
