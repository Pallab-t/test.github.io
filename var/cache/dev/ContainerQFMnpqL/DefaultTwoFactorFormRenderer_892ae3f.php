...
class DefaultTwoFactorFormRenderer_892ae3f extends \Scheb\TwoFactorBundle\Security\TwoFactor\Provider\DefaultTwoFactorFormRenderer implements \ProxyManager\Proxy\VirtualProxyInterface
{
    ...
    {
        $this->initializer6e180 && ($this->initializer6e180->__invoke($valueHoldercb2a9, $this, 'renderForm', array('request' => $request, 'templateVars' => $templateVars), $this->initializer6e180) || 1) && $this->valueHoldercb2a9 = $valueHoldercb2a9;

        return $this->valueHoldercb2a9->renderForm($request, $templateVars);
    }
    ...
    public function __construct(\Twig\Environment $twigRenderer, string $template)
    {
        ...
        $this->valueHoldercb2a9->__construct($twigRenderer, $template);
    }
